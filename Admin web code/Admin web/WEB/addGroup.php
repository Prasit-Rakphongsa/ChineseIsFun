...
<nav class="w3-sidebar w3-bar-block w3-white w3-animate-left w3-text-grey w3-collapse w3-top w3-center" style="z-index:3;width:300px;font-weight:bold" id="mySidebar"><br>
  ...
  <a href="javascript:void(0)" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-hide-large">CLOSE</a>
    <a href="index.php" onclick="w3_close()" class="w3-bar-item w3-button c clickcolor" style="font-size:18px;">UPDATE GROUP</a>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
	...
	$mysql_qry = "select * from QuestionsGroup where LESSON_id='$value'";
    ...
    $numrows = $result->num_rows;
 	while($row = mysqli_fetch_array($result)) {
		echo'<tr>
			...
			<td class="c"><p style="font-size:20px;">'.$row['QuestionContent'].'</p></td>
			</tr>';
	}
...
?>
      ...
      <form name="add_name" id="add_name" action="SQLaddGroup.php" method="POST">  
                          <div class="table-responsive">  
                               <table align="center" id="dynamic_field" style="margin-top:20px;" class="table" width="90%">  
                                    <tr>  
                                        <td ><p style="font-size:20px; color:#ffcccc;">New Group Of Content</p></td>
										<td width="50%"><input type="text" name="content" placeholder="content" class="form-control name_list" /></td>
										 <td ><input type="hidden" name="lesson" value="<?php echo($value) ?>" /></td>
                                        <td><input type="submit" name="submit" id="submit" class="btn btn-info" value="Save" /> </td>
                                         <td ><input type="hidden" name="numGroup" value="<?php echo($numrows) ?>" /></td>
                                    </tr>  
                               </table>  
                          </div>  
                     </form>  
