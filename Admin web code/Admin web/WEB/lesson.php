...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
    <h4 style="font-size:25px;"><b>LESSON</b></h4>
    ...
    <div class="w3-content w3-justify" style="max-width:645px">
      <form name="add_name" id="add_name" method="POST" action="addGroup.php">  
                          <div class="table-responsive" >  
                               <table align="center" style="margin-top:20px;" id="dynamic_field">  
                                <?php $value=$_POST['cate'];
                                    echo '<tr > 
                                         <td><button type="submit" name="value" class="btn-success button" value="'.$value.'.1">LESSON 1/3</button></td>
                                    </tr>  
									<tr>  
                                         <td><button type="submit" name="value" class="btn-success button"  value="'.$value.'.2">LESSON 2/3</button></td>
                                      
                                    </tr>
                                    <tr>  
                                         <td><button type="submit" name="value" class="btn-success button"  value="'.$value.'.3">LESSON 3/3</button></td>
